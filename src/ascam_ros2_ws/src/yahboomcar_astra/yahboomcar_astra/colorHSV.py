...
class Color_Identify(Node):
    def __init__(self,name):
        ...
        self.sub_img = self.create_subscription(Image,'/ascamera_hp60c/camera_publisher/rgb0/image',self.handleTopic,1)
        self.index = 2
        self.Roi_init = ()
        self.hsv_range = ()
        self.circle = (0, 0, 0)
        ...
        self.hsv_text = "/home/yahboom/ascam_ros2_ws/src/yahboomcar_astra/yahboomcar_astra/colorHSV.text"
